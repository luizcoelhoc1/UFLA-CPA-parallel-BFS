...
void eachValueProcess(AdjacencyMatrix<edge>* G, Element<vertex>* element, Bag<vertex>* outBag, vector<vertex>* distances, int distance) {
...
void processPennant(AdjacencyMatrix<edge>* G, Bag<vertex> inBag, Element<vertex>* inPennant, int sizePennant, Bag<vertex>* outBag, vector<int>* distances, int distance) {
...
void processLayer(AdjacencyMatrix<edge>* G, Bag<vertex> inBag, Bag<vertex>* outBag, vector<int>* distances, int distance) {
...
vector<int> parallelBFS(AdjacencyMatrix<edge> G, int v0) {
	int distance = 0;
